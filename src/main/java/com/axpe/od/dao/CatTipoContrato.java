...
/**
 * The persistent class for the cat_tipo_contrato database table.
 * 
 */
@Entity
@Table(name="cat_tipo_contrato", schema="monolito_god")
@NamedQuery(name="CatTipoContrato.findAll", query="SELECT c FROM CatTipoContrato c")
